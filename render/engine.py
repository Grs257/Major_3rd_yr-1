...
class Engine:
    ...
    def draw(self):
        ...
        pygame.display.set_caption(
            f"{self.title} - {self.instructions[self.instruction_index]}"
        )
    ...
    def run_simulation(
        self, genomes: List[neat.DefaultGenome], config: neat.Config
    ) -> None:
        ...
        while True:
            ...
            caption = (
                f"{self.title} - Generation: {car_ai.TOTAL_GENERATIONS} - "
